...
public class CdkApp {
	...
	private static final String STACK_NAME = "ECOMINV";
	...
	private static void validate() throws Exception {
		...
		checkEnvVariableWithDefaults("SupplyDemandOpResvConcurrency", 0);
		checkEnvVariableWithDefaults("AvailabilityOpResvConcurrency", 0);
		checkEnvVariableWithDefaults("SupplyDemandOpProvConcurrency", 0);
		checkEnvVariableWithDefaults("AvailabilityOpProvConcurrency", 0);
