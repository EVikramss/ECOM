...
public class OrderDataMapper {
	...
	public com.ecom.dto.OrderData convertToDTO(OrderData inputData, boolean deepCopy) {
	...
	public List<com.ecom.dto.OrderData> convertToDTO(Iterable<OrderData> inputData, boolean deepCopy) {

		List<com.ecom.dto.OrderData> output = new ArrayList<com.ecom.dto.OrderData>();

		Iterator<OrderData> iter = inputData.iterator();
		while (iter.hasNext()) {
			OrderData data = iter.next();
			com.ecom.dto.OrderData outputData = convertToDTO(data, deepCopy);
